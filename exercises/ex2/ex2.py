...
class Car(Vehicle):
    ...
    def move(self, new_x, new_y):
        """Move this Car to a new position.
...
class Helicopter(Vehicle):
    ...
    def fuel_needed(self, new_x, new_y):
        ...
        @rtype: float
        """
        return sqrt((abs(self.position[0] - new_x))**2 + (abs(self.position[1] - new_y))**2)
...
class UnreliableMagicCarpet(Vehicle):
    ...
    def __init__(self, new_fuel):
        ...
        @type self: UnreliableMagicCarpet
        @type new_fuel: int
        @rtype: None
        """
        ...
        Vehicle.__init__(self, new_fuel, position)
    ...
    def move(self, new_x, new_y):
        ...
        @rtype: None
        """
        _dx = random.randint(-2, 2)
        _dy = random.randint(-2, 2)

        self.position = (new_x + _dx, new_y + _dy)

    def fuel_needed(self, new_x, new_y):
        """
        The magic carpet does not use fuel
        """
        pass
